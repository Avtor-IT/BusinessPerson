...
export const MyManager = ({ className, children, ...props }) => {
    return (
        <Card className={`${cls.MyManager}`}>
            ...
            >
                ...
                <Button variant={'unStyled'} className={`${cls.btnMessage}`}>
            ...
            <Box className={`${cls.infoManager}`}>
                <Box className={`${cls.avatarFIO}`}>
                    <AvatarManager />
                    <Typography style={{ fontSize: '20px', fontWeight: '400', lineHeight: '1.3' }}>
                        Менеджерова<br />
                        Менедж<br />
                        Менеджеровна
                    </Typography>
